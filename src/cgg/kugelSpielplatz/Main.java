...
public class Main {
    ...
    // IMaterial mond = new EmissiveMaterial(imageTexture9,white, 100);
     ...
     IMaterial sunEmission = new EmissiveMaterial(imageTexture6, white, 100);
...
//////////////////////////////////////////////////////
   ...
   // scene.add(new Sphere(vec3(0,0,-5), 2, new TransmissiveMaterial(1.5)));
    ...
    double radius = 2;
    Sphere sphere = new Sphere(vec3(0, 0, 0), radius, new TransmissiveMaterial(1.3));
    ...
    Group person = new Group(move(0,2,-10));
    person.addShape(body);
    //root.addShape(person);

    Plane glassPlane = new Plane (vec3(0,0,0), 1, 1000, new TransmissiveMaterial(1.4));

    Group cubesphere = new Group(scale(1,1,0.1));

    Sphere cubeSphere = new Sphere(vec3(0,0,0), 1, black);

    cubesphere.addShape(cubeSphere);
    ...
    Group cube = new Group(new Transform(multiply(move(0,0,-2), rotate(Vec3.yAxis, 20), scale(0.2,0.2,0.2))));

    frontCube.addShape(cubesphere);
    backCube.addShape(glassPlane);
    leftCube.addShape(cubesphere);
    rightCube.addShape(cubesphere);
    topCube.addShape(cubesphere);
    bottomCube.addShape(cubesphere);
    ...
    root.addShape(cube);
        ...
        // lensegroup.addShape(new Sphere(vec3(0,0,-0.5), 0.4, new TransmissiveMaterial(1.05)));
        // scene.add(lensegroup);

    

    root.addShape(new Sphere(vec3(-3,0,-6), 2, mirror));
