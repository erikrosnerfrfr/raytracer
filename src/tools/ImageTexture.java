...
public class ImageTexture implements ISampler {
  ...
  public static Color applyGamma(Color color, double gamma) {
    double correctedr = Math.pow(color.r(),gamma);
    double correctedg = Math.pow(color.g(),gamma);
    double correctedb = Math.pow(color.b(),gamma);
